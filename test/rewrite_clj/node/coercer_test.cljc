...
(deftest t-sexpr->node->sexpr-roundtrip
  (testing "simple cases roundtrip"
    (doseq [[sexpr expected-tag expected-type]
            [;; numbers
             ...
             #?@(:clj ;; ratios are not valid in cljs
                 [[3/4               :token      :token]])
...
(deftest t-quoted-list-reader-location-metadata-elided
  (doseq [[sexpr expected-meta-keys]
          [['(1 2 3)              "(1 2 3)"]
