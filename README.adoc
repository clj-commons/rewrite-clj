...
* https://github.com/lambdaisland/classpath[classpath] {canary-tested} - Classpath/classloader/deps.edn related utilities
...
// tests failed for me when I tried them
* https://github.com/paintparty/jus[jus] {not-canary-tested} - TUI app for Clojure dialects
...
image:nnichols.png[nnichols,role="left",width=250,link="https://github.com/nnichols"]
image:NoahTheDuke.png[NoahTheDuke,role="left",width=250,link="https://github.com/NoahTheDuke"]
image:onbreath.png[onbreath,role="left",width=250,link="https://github.com/onbreath"]
...
image:alexander-yakushev.png[alexander-yakushev,role="left",width=250,link="https://github.com/alexander-yakushev"]
...
image:hoebat.png[hoebat,role="left",width=250,link="https://github.com/hoebat"]
