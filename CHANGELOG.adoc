...
=== v1.2.57 - 2026-08-29 [[v1.2.57]]

* ci: fix error in rewrite-clj lib publish flow
({lread})

https://github.com/clj-commons/rewrite-clj/compare/v1.2.56\...v1.2.57[commit log]

=== v1.2.56 - 2026-08-29 [[v1.2.56]]

* fix: Don't crash when 1-char buffer PBR is provided.
{issue}466[#466] ({person}alexander-yakushev[@alexander-yakushev])
* perf: Reduce memory pressure and increase performance by changing the way rewrite-clj internally concats strings
{issue}478[#478] ({person}nnichols[@nnichols])

https://github.com/clj-commons/rewrite-clj/compare/v1.2.55\...v1.2.56[commit log]
...
https://github.com/clj-commons/rewrite-clj/compare/v1.2.54\...v1.2.55[commit log]
...
{issue}439[#439] ({person}alexander-yakushev[@alexander-yakushev])

https://github.com/clj-commons/rewrite-clj/compare/v1.2.52\...v1.2.53[commit log]

=== v1.2.52 - 2026-03-01 [[v1.2.52]]

* `coerce` all ``ISeq``s to lists (instead of handful of specific seqs)
{issue}435[#435] ({lread}, thanks for the issue {person}shaunlebron[@shaunlebron]!)
* bump clojure tools reader to v1.6.0
{issue}427[#427] ({lread})

https://github.com/clj-commons/rewrite-clj/compare/v1.2.51\...v1.2.52[commit log]

=== v1.2.51 - 2025-12-31 [[v1.2.51]]

* `sexpr` now uses `array-map` for maps with up to 8 key-value pairs, to preserve the original order.
{pr}419[#419] ({person}onbreath[@onbreath])

https://github.com/clj-commons/rewrite-clj/compare/v1.2.50\...v1.2.51[commit log]
