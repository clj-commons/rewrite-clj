...
;; this project started with "clojars-", but we prefer "v" as a version tag prefix
(def legacy-version-tag-prefixes ["clojars-"])
...
(comment
  ...
  ;; => {:tag "v1.1.46", :version "1.1.46"}

  (parse-raw-tag "boo refs/tags/clojars-0.1.1")
  ;; => {:tag "clojars-0.1.1", :version "0.1.1"}
